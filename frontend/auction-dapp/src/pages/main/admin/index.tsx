...
const AdminPage = () => {
        ...
        <div className="text-center max-w-md mx-auto p-8">
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
            <p className="text-sm text-blue-800">
              Admin access requires an AuctionHouseCap NFT in your connected
              wallet.
            </p>
          </div>
        </div>
  ...
  return (
    <div className="w-full min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50">
      <div className="container px-4 sm:px-6 lg:px-8 py-8 flex flex-col gap-8">
        {/* Header Section */}
        <div className="text-center mb-8 flex flex-col gap-4 items-center">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Manage auction house fees, treasury settings, and administrative
            capabilities
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 flex flex-col gap-6">
            ...
            <div className="bg-white border border-gray-100 rounded-2xl shadow-xl p-6 flex flex-col gap-3">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Monitor and manage collected auction fees
                    </p>
                  </div>
                </div>
                <button
                  ...
                  <div className="bg-gradient-to-r from-green-500 to-emerald-600 rounded-xl p-6 text-white">
                    ...
                    <div className="space-y-2">
                      <p className="text-4xl font-bold">
                        {registryFeeInfo
                          ? formatSui(registryFeeInfo.feeBalance)
                          : "0.0000"}{" "}
                        SUI
                      </p>
                      ...
                      {registryFeeInfo && (
                        <p className="text-xs text-green-200 font-mono">
                          {(registryFeeInfo.feeBalance * 1_000_000_000).toFixed(
                            0,
                          )}{" "}
                          MIST
                        </p>
            ...
            <div className="bg-white border border-gray-100 rounded-2xl shadow-xl p-6 flex flex-col gap-3">
              ...
              <div className="flex flex-col gap-3">
                <div className="bg-purple-50 rounded-xl p-6 flex flex-col gap-2">
            ...
            <div className="bg-white border border-gray-100 rounded-2xl shadow-xl p-6 flex flex-col gap-3">
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Create new admin capabilities for trusted users
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-3">
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-yellow-700">
                        Creating admin capabilities grants full administrative
                        access to the auction house. Only grant admin access to
                        trusted addresses. This action cannot be undone.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="flex flex-col gap-2">
                  ...
                  />
                  <p className="text-xs text-gray-500 mt-1">
                    The recipient will receive an AuctionHouseCap NFT granting
                    admin privileges
                  </p>
                </div>
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-8 flex flex-col gap-6">
              ...
              <div className="bg-gradient-to-br from-blue-400 to-indigo-500 rounded-2xl shadow-xl p-6 text-white flex flex-col gap-3">
                ...
                <div className="flex flex-col gap-3 text-sm">
                  ...
                  <div className="bg-white/10 rounded-lg p-3">
                    ...
                    <p className="text-blue-100">
                      When auctions complete (NFT claimed or creator claims
                      proceeds)
                    </p>
                  </div>
                  ...
                  <div className="bg-white/10 rounded-lg p-3">
                    ...
                    <p className="text-blue-100">
                      All fees stored in auction registry
                    </p>
                  </div>
              ...
              {/* Security Notice */}
              <div className="bg-gradient-to-br from-red-400 to-pink-500 rounded-2xl shadow-xl p-6 text-white flex flex-col gap-3">
                ...
                <div className="space-y-3 text-sm">
                  <p className="text-red-100">
                    Only accounts with AuctionHouseCap can perform admin
                    actions.
                  </p>
                  <p className="text-red-100">
                    Keep your admin capabilities secure and never share access
                    with untrusted parties.
                  </p>
                  <p className="text-red-100">
                    All admin actions are recorded on the blockchain for
                    transparency.
                  </p>
                </div>
              </div>
